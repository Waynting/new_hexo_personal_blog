...
export default function PostCard({
  ...
  const getCategoryColor = (categoryName: string): string => {
    const colorMap: Record<string, string> = {
      ...
      '台大資管生活': 'bg-blue-100 text-black dark:bg-blue-900/30 dark:text-blue-300',
      '科學班生活': 'bg-purple-100 text-black dark:bg-purple-900/30 dark:text-purple-300',
      '攝影筆記': 'bg-green-100 text-black dark:bg-green-900/30 dark:text-green-300',
      '城市漫步': 'bg-yellow-100 text-black dark:bg-yellow-900/30 dark:text-yellow-300',
      '生活日誌': 'bg-pink-100 text-black dark:bg-pink-900/30 dark:text-pink-300',
      '讀書筆記與心得': 'bg-indigo-100 text-black dark:bg-indigo-900/30 dark:text-indigo-300',
      '技術筆記': 'bg-red-100 text-black dark:bg-red-900/30 dark:text-red-300',
    };
    return colorMap[categoryName] || 'bg-gray-100 text-black dark:bg-gray-900/30 dark:text-gray-300';
  };
